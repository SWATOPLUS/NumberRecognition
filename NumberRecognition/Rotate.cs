...
namespace NumberRecognition
{
    public static class ExtBitmap
    {
        ...
        private static Point RotateXY(this Point source, double degrees,
        ...
        public static Bitmap RotateImage(this Bitmap sourceBitmap, double angle)
        {
            return RotateImage(sourceBitmap, angle, angle, angle);
        }

        private static Bitmap RotateImage(this Bitmap sourceBitmap,
                                               double degreesBlue,
                                              double degreesGreen,
                                                double degreesRed)
        {
